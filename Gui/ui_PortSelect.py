...
class Ui_Dialog_PortSelect(object):
    def setupUi(self, Dialog_PortSelect):
        ...
        Dialog_PortSelect.resize(708, 419)
        self.horizontalLayoutWidget_2 = QtWidgets.QWidget(Dialog_PortSelect)
        self.horizontalLayoutWidget_2.setGeometry(QtCore.QRect(0, 0, 708, 294))
        ...
        self.label_DealySet = QtWidgets.QLabel(self.horizontalLayoutWidget_2)
        self.label_DealySet.setObjectName("label_DealySet")
        self.gridLayout.addWidget(self.label_DealySet, 4, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_IsOpenOrNot, 6, 2, 1, 1)
        ...
        self.lineEdit_SendDelay = QtWidgets.QLineEdit(self.horizontalLayoutWidget_2)
        self.lineEdit_SendDelay.setObjectName("lineEdit_SendDelay")
        self.gridLayout.addWidget(self.lineEdit_SendDelay, 4, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.pushButton_OpenPort, 6, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.pushButton_ClosePort, 6, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_Statusbar, 10, 0, 1, 1)
        self.checkBox_AutoSend = QtWidgets.QCheckBox(self.horizontalLayoutWidget_2)
        self.checkBox_AutoSend.setMinimumSize(QtCore.QSize(100, 0))
        self.checkBox_AutoSend.setObjectName("checkBox_AutoSend")
        self.gridLayout.addWidget(self.checkBox_AutoSend, 4, 0, 1, 1)
        self.label_Time = QtWidgets.QLabel(self.horizontalLayoutWidget_2)
        self.label_Time.setMinimumSize(QtCore.QSize(150, 0))
        self.label_Time.setObjectName("label_Time")
        self.gridLayout.addWidget(self.label_Time, 7, 1, 1, 1)
    ...
    def retranslateUi(self, Dialog_PortSelect):
        ...
        self.label_DealySet.setText(_translate("Dialog_PortSelect", "m/s"))
        self.comboBox_BaudRate.setItemText(0, _translate("Dialog_PortSelect", "1200"))
        self.comboBox_BaudRate.setItemText(1, _translate("Dialog_PortSelect", "2400"))
        self.comboBox_BaudRate.setItemText(2, _translate("Dialog_PortSelect", "4000"))
        self.comboBox_BaudRate.setItemText(3, _translate("Dialog_PortSelect", "4800"))
        self.comboBox_BaudRate.setItemText(4, _translate("Dialog_PortSelect", "9600"))
        self.comboBox_BaudRate.setItemText(5, _translate("Dialog_PortSelect", "14400"))
        self.comboBox_BaudRate.setItemText(6, _translate("Dialog_PortSelect", "19200"))
        self.comboBox_BaudRate.setItemText(7, _translate("Dialog_PortSelect", "38400"))
        self.comboBox_BaudRate.setItemText(8, _translate("Dialog_PortSelect", "43000"))
        self.comboBox_BaudRate.setItemText(9, _translate("Dialog_PortSelect", "57600"))
        self.comboBox_BaudRate.setItemText(10, _translate("Dialog_PortSelect", "76800"))
        self.comboBox_BaudRate.setItemText(11, _translate("Dialog_PortSelect", "115200"))
        self.comboBox_BaudRate.setItemText(12, _translate("Dialog_PortSelect", "128000"))
        self.comboBox_BaudRate.setItemText(13, _translate("Dialog_PortSelect", "256000"))
        self.comboBox_BaudRate.setItemText(14, _translate("Dialog_PortSelect", "460800"))
        ...
        self.checkBox_AutoSend.setText(_translate("Dialog_PortSelect", "Auto Send"))
